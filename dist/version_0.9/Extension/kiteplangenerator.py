...
class KitePlan(inkex.Effect):
    def __init__(self):
        ...
        self.OptionParser.add_option("", "--end_of_spine", action="store", type="int", dest="end_of_spine", default=0, help="command line help")
        self.OptionParser.add_option("", "--nose_cut_width", action="store", type="int", dest="nose_cut_width", default=0, help="command line help")
        self.OptionParser.add_option("", "--tail_cut_width", action="store", type="int", dest="tail_cut_width", default=0, help="command line help")
        self.OptionParser.add_option("", "--upper_center", action="store", type="int", dest="upper_center", default=0, help="command line help")
        self.OptionParser.add_option("", "--lower_center", action="store", type="int", dest="lower_center", default=0, help="command line help")
        self.OptionParser.add_option("", "--end_of_leading_edge", action="store", type="int", dest="end_of_leading_edge", default=0, help="command line help")
        self.OptionParser.add_option("", "--end_of_leading_edge_height", action="store", type="int", dest="end_of_leading_edge_height", default=0, help="command line help")
        self.OptionParser.add_option("", "--wingspan", action="store", type="int", dest="wingspan", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_pos_1", action="store", type="int", dest="standoff_pos_1", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_len_1", action="store", type="int", dest="standoff_len_1", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_offset_1", action="store", type="float", dest="standoff_offset_1", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_pos_2", action="store", type="int", dest="standoff_pos_2", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_len_2", action="store", type="int", dest="standoff_len_2", default=0, help="command line help")
        self.OptionParser.add_option("", "--standoff_offset_2", action="store", type="float", dest="standoff_offset_2", default=0, help="command line help")
        self.OptionParser.add_option("", "--le_ctrlpt1_x", action="store", type="int", dest="le_ctrlpt1_x", default=0, help="command line help")
        self.OptionParser.add_option("", "--le_ctrlpt1_y", action="store", type="float", dest="le_ctrlpt1_y", default=0, help="command line help")
        self.OptionParser.add_option("", "--le_ctrlpt2_x", action="store", type="int", dest="le_ctrlpt2_x", default=0, help="command line help")
        self.OptionParser.add_option("", "--le_ctrlpt2_y", action="store", type="float", dest="le_ctrlpt2_y", default=0, help="command line help")
        self.OptionParser.add_option("", "--te_ctrlpt_inner", action="store", type="int", dest="te_ctrlpt_inner", default=0, help="command line help")
        self.OptionParser.add_option("", "--te_ctrlpt_outer", action="store", type="int", dest="te_ctrlpt_outer", default=0, help="command line help")
        self.OptionParser.add_option("", "--active-tab", action="store", type="string", dest="active_tab", default='title', help="Active tab.")
        self.OptionParser.add_option("-s", "--render_type", action="store", type="string", dest="render_type", default='overview', help="command line help")

    def add_description (self, layer, kite):
        svg = self.document.getroot()
        doc_left = self.unittouu(svg.get('width'))        
        doc_1mm = self.unittouu("1mm")
        font_size = 2.75 * doc_1mm

        x0 = doc_left - 293 * doc_1mm
        y0 = 10 * doc_1mm

        flowRoot=inkex.etree.SubElement(layer,inkex.addNS('flowRoot','svg'),{inkex.addNS('space','xml'):'preserve'})
    ...
    def add_plan (self, layer, kite):
        ...
        x0 = 20 * doc_1mm
        y0 = self.unittouu(svg.attrib['height']) - (kite.Parameters.end_of_spine + 10) * doc_1mm
    ...
    def add_texture (self, layer, kite):
        ...
        x0 = 50 * doc_01mm
        y0 = self.unittouu(svg.attrib['height']) - 1650 * doc_01mm
